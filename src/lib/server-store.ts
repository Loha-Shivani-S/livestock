...
class MemoryStore {
  ...
  gateways: Gateway[] = [
    {
      id: "gw-01",
      node_id: "GW-GOBICHETTI-01",
      label: "Gobichettipalayam Base Tower",
      village: "Gobichettipalayam Pasture",
      block: "Gobichettipalayam",
      district: "Erode",
      lat: 11.235695,
  ...
  alert_recipients: AlertRecipient[] = [
    {
      id: "rec-owner-01",
      full_name: "Loha Shivani (Farm Commander & Veterinary Lead)",
  ...
  notifications: NotificationLog[] = [
    {
      ...
      subject: "[CRITICAL] Critical BDI spike from collar IN-TN-2031-4471",
      body: "[CRITICAL] Critical BDI spike from collar IN-TN-2031-4471 — Gobichettipalayam. Temp 40.8 C, HR 94 bpm, BDI 0.88. Immediate field verification advised.",
      status: "sent",
      error: null,
      alert_id: "alt-01",
      report_id: null,
    ...
    },
    {
      ...
      subject: "[CRITICAL] Critical BDI spike from collar IN-TN-2031-4471",
      body: "High-temperature and resting anomaly detected in Gobichettipalayam. Animal ID: IN-TN-2031-4471. Open HerdSentinel console for 3 km quarantine ring details.",
      status: "sent",
      error: null,
      alert_id: "alt-01",
      report_id: null,
  ...
  vaccinations = [
    {
      ...
      batch_no: "RO-2025-88",
      administered_by: "Dr. M. Senthilkumar",
    },
    {
      id: "v2",
      tag_id: "IN-TN-2031-4471",
